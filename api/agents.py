...
def get_moon_strategy():
    ...
    strategies = [
        ...
        "Bridge USDC to Solana -> Deploy across Murad Solana Memecoin using Raydium swap or Jupiter decentralized exchange",
        "Deposit USDC into Hyperliquid (Appchain), Aevo (Base) or Drift (Solana), 2-5x leveraged on BTC"
    ]
